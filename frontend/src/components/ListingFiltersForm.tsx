...
export default function ListingFiltersForm({
  ...
  return (
    <div className="flex flex-wrap gap-4 items-end bg-radar-card/40 border border-radar-border
                    rounded-lg p-4">
      <TextInput name="make"        label="Make"        placeholder="Porsche"  />
      <TextInput name="model"       label="Model"       placeholder="911"      />
      ...
      />
      <NumberInput name="year_min"  label="Year min"    placeholder="1900"     />
      <NumberInput name="year_max"  label="Year max"    placeholder="2000"     />
