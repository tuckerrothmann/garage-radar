...
class TestClusterKey:
    def test_basic_format(self):
        assert (
            ...
            == "porsche:911:g6:coupe:manual:usd"
        )

    def test_year_bucket_format(self):
        assert (
            cluster_key_for(
                "Ford",
                "Bronco",
            ...
            == "ford:bronco:y1972:suv:manual:usd"
        )

    def test_slugifies_multiword_values(self):
        assert (
            cluster_key_for(
                "Land Rover",
                "Defender 110",
            ...
            == "land-rover:defender-110:y1995:suv:auto:gbp"
        )

    def test_requires_generation_or_year_bucket(self):
        with pytest.raises(ValueError):
            cluster_key_for("BMW", "M3", "coupe", "manual", currency="USD")
